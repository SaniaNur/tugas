...
<script>
    jQuery(document).ready(function($) {
        $.get("{{ $field['data_source'] }}/{{ $field['value'] }}", function(hasil){
            $("#select2_ajax_{{ $field['name'] }}").select2('data', {id:hasil.id, text:hasil.{{ $field['attribute'] }}}).trigger('change');
        });
